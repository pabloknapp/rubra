...
export function CardCarta({ data }: { data: CartaType }) {
  return (
    <div className="group relative flex flex-col bg-white border border-slate-200 rounded-2xl shadow-sm transition-all duration-300 overflow-hidden">
      <div className="relative overflow-hidden h-52 sm:h-60 flex items-center justify-center p-4">
        <img
          className="w-full h-full object-contain group-hover:scale-105 group-hover:rotate-1 transition-transform duration-500 ease-out"
          src={data.imagem}
          alt={data.pokemon}
        />
      ...
      <div className="flex flex-col flex-grow p-5 sm:p-6">
        <div className="flex-grow">
          ...
          <div className="flex items-end mb-4">
            <span className="text-sm font-semibold text-slate-500 mb-1 mr-1">R$</span>
